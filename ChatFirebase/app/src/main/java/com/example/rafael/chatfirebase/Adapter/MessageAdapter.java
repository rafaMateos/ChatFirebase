...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder>{
    ...
    public MessageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if(i == MSG_TYPE_RIGHT){ view = LayoutInflater.from(mContext).inflate(R.layout.chat_item_right,viewGroup,false); }

        else{ view = LayoutInflater.from(mContext).inflate(R.layout.chat_item_left,viewGroup,false); }
